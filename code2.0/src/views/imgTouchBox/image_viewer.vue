    ...
    <div tabindex="-1" ref="el-image-viewer__wrapper" class="el-image-viewer__wrapper"  :style="{ 'z-index': zIndex }">
      ...
      <div class="el-image-viewer__btn el-image-viewer__actions" >
        <div class="el-image-viewer__actions__inner">
          ...
          <i :class="mode.icon" @click.self="toggleMode"></i>
          <i class="el-image-viewer__actions__divider"></i>
          <i class="el-icon-refresh-left" @click.self="handleActions('anticlocelise')"></i>
          <i class="el-icon-refresh-right" @click.self="handleActions('clocelise')"></i>
        </div>
      </div>
      <!-- CANVAS -->
