<template>
	<view class="classify fx  h100 box">
		<view class="leftTabl scroll_h fxb_180 p_20 flow_h fx_col">
			<scroll-view :scroll-y="true" :scroll-with-animation="true" class="classList fx_col flow_y  fx_1 backColor scroll_h"
				:scroll-into-view="classActiveId">
		...
		<view class="right_list fx_1 fx_col p_20 fx_col bfff">
					...
					for (let i = 0; i < _this.leftClassList.length; i++) {
						...
						query.select(id).boundingClientRect(data => {
							if (data) {
								...
								if ((data.top-5)<=0 && data.top >(data.height*-1) ) {
